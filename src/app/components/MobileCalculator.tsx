...
export default function MobileCalculator() {
  ...
  const interpretations:any = {
    ...
    4: { energy: "Stability", color: "Green", description: "Your number brings practical success and steady growth. Excellent for long-term planning." },
    5: { energy: "Adventure", color: "Blue", description: "This vibration attracts travel, change, and dynamic opportunities. Perfect for flexible careers." },
    6: { energy: "Nurturing", color: "Indigo", description: "Your number enhances family harmony and healing abilities. Great for service-oriented professions." },
    7: { energy: "Spirituality", color: "Violet", description: "This vibration attracts spiritual growth and analytical thinking. Ideal for researchers and mystics." },
    8: { energy: "Material Success", color: "Pink", description: "Your number brings material abundance and executive power. Excellent for business and finance." },
    9: { energy: "Universal Love", color: "Gold", description: "This vibration attracts humanitarian opportunities and global connections. Perfect for healers and teachers." }
  }
  ...
  const calculateNumerology = () => {
    ...
    const finalNumber = sum > 9 ? sum.toString().split('').map(Number).reduce((a, b) => a + b, 0) : sum
  ...
  const openWhatsApp = () => {
    const message = encodeURIComponent("Hi! I want a detailed mobile numerology analysis. Please guide me.")
