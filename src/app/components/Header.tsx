      ...
      <header className="text-center py-16 px-5">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg max-w-3xl mx-auto leading-relaxed text-mystical-50 font-light">
            Transform uncertainty into clarity with ancient wisdom and modern accessibility. 
            Our expert practitioners combine thousands of years of astrological knowledge 
            to reveal your unique path forward and empower confident life decisions.
          </p>
        </div>
      </header>
    )
